 ...
 * Copyright (c) 2009-2011 by HelloWorld, Inc. All Rights Reserved.
...
@interface HelloWorldObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[HelloWorldObject class]])
		{
			for (NSString *key in [[(HelloWorldObject*)o modules] allKeys])
			{
