...
// in simulator we redefine to format for HelloWorld Developer console
...
{\
	NSString * exceptionName = [@"org.helloworld." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.helloworld";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIHelloWorldNativeItemNone = -1, 
	UIHelloWorldNativeItemSpinner = -2,
	UIHelloWorldNativeItemProgressBar = -3,
	
	UIHelloWorldNativeItemSlider = -4,
	UIHelloWorldNativeItemSwitch = -5,
	UIHelloWorldNativeItemMultiButton = -6,
	UIHelloWorldNativeItemSegmented = -7,
	
	UIHelloWorldNativeItemTextView = -8,
	UIHelloWorldNativeItemTextField = -9,
	UIHelloWorldNativeItemSearchBar = -10,
	
	UIHelloWorldNativeItemPicker = -11,
	UIHelloWorldNativeItemDatePicker = -12,
	
	UIHelloWorldNativeItemInfoLight = -13,
	UIHelloWorldNativeItemInfoDark = -14,
	
	UIHelloWorldNativeItemDisclosure = -15,
	
	UIHelloWorldNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all HelloWorld instances of
