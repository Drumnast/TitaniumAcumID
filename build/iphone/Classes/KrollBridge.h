...
@interface HelloWorldObject : KrollCoverageObject {
#else
@interface HelloWorldObject : KrollObject {
#endif
@private
...
extern NSString * HelloWorld$ModuleRequireFormat;
