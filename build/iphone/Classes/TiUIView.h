...
/**
 Base class for all HelloWorld views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the HelloWorld view hierarchy (such as wrapped iOS UIViews) was touched.
